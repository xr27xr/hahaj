...
'reply_markup'=>json_encode([
 'inline_keyboard'=>[
 [
['text'=>"FFIFF8",'url'=>"https://t.me/FFIFF8"],['text'=>"$dataadd",'callback_data'=>"text"]
],
]
])
]); 
...
'reply_markup'=>json_encode([
 'inline_keyboard'=>[
 [
['text'=>"DeV Ch",'url'=>"https://t.me/FFIFF8"]
],
]
])
]); 
...
////////////////////////////////////////////////
$step1 = json_decode(file_get_contents("https://api.telegram.org/bot".$tk."/getChatMember?chat_id=$chat_id&user_id=$idbotak"),true);
...
'chat_id'=>$chat_id,
'text'=>"
⌯⁞  تم كشف صلاحيات البوت بالمجموعة
⌯⁞  النتائج كالتالي
⌯⁞  صلاحية تغيير معلومات المجموعة $check3
⌯⁞  صلاحية مسح الرسائل $check4
⌯⁞  صلاحية حظر وتقييد مستخدمين $check5
⌯⁞  صلاحية دعوة مستخدمين $check6
⌯⁞  صلاحية تثبيت الرسائل $check7
⌯⁞  صلاحية اضافة مشرفين جدد $check8
",'reply_to_message_id'=>$message->message_id,
]);}}
...
[["text"=>"ـ مطور السورس",'url'=>"t.me/kiindi"]],
]
]) 
]); 
}
